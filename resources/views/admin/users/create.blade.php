...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1" style="color: var(--text-primary); font-family: 'Playfair Display', serif;">Add New User</h4>
                <p class="text-secondary small mb-0">Create a new account with specific roles and permissions.</p>
            </div>
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-text text-secondary mt-2 small">
                                <i class="fas fa-info-circle me-1"></i> Roles define what permissions the user will have in the system.
                            </div>
                        </div>
                    </div>
